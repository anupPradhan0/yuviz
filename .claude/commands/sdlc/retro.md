...
2. Read `.claude/sdlc/lessons.md`. If an existing lesson already covers the class, sharpen that entry with the new evidence instead of adding a near-duplicate. Merge aggressively; a long lessons file stops being read.
