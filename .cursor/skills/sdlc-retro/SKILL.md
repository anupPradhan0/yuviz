...
2. Read `.cursor/sdlc/lessons.md`. If an existing lesson already covers the class, sharpen that entry with the new evidence instead of adding a near-duplicate. Merge aggressively; a long lessons file stops being read.
...
6. If `.claude/sdlc/lessons.md` also exists and you added or sharpened a lesson, mirror the same change there so Claude and Cursor stay aligned.
