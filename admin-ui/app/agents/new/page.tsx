...
export default function NewAgentPage() {
  ...
  // Same engine-lock/chooser pattern as the agent detail page's Voice card
  // (see that page for the full rationale) — duplicated rather than shared
  // for the same reason as PromptSections above: this page has no agent/
  // form yet, just local state.
  ...
  // Picking a voice sets the language to match it, rather than the other
  // way around — same reasoning as the agent detail page's identical helper.
              ...
              <div className="card" style={{ marginBottom: 14 }}>
                ...
                <div className="card-body">
                  {(() => {
                    ...
                    if (!createdAgent && (showEngineChooser || !engine)) {
                      return (
                        <div>
                    ...
                    if (!engine) {
                      // createdAgent is set but no engine was ever chosen —
                      // nothing to show (matches every other "locked, empty"
                      // field's posture post-creation).
                      return <div className="empty-state">No voice selected.</div>;
                    }

                    const changeEngineButton = !createdAgent && (
                    ...
                    return (
                      <div className="form-group" style={{ marginTop: 12, marginBottom: 0 }}>
                        ...
                        <select
                          ...
                          style={{ width: 140 }}
                          value={String(speed)}
                          disabled={!selectedTts || !!createdAgent}
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              setSpeedError(err instanceof ApiError ? err.detail : String(err));
                            }
                          }}
                        >
